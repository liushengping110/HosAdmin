package wizrole.hosadmin.util.dialog;
...
public class SelectDialog extends Dialog implements OnClickListener,OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View view = getLayoutInflater().inflate(R.layout.dialog_photo_select,
                null);
    ...
    private class DialogAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            if (null == convertView) {
                ...
                convertView=layoutInflater.inflate(R.layout.dialog_photo_select_item, null);
            ...
            if (!mUseCustomColor) {
                mFirstItemColor = mActivity.getResources().getColor(R.color.bule);
                mOtherItemColor = mActivity.getResources().getColor(R.color.bule);
            }
            if (1 == mStrings.size()) {
